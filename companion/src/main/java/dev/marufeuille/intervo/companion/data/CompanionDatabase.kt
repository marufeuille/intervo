...
@Database(entities = [CompanionWorkoutHistory::class], version = 8, exportSchema = false)
        ...
        fun getInstance(context: Context): CompanionDatabase =
            INSTANCE ?: synchronized(this) {
                INSTANCE ?: Room.databaseBuilder(
                    ...
                    // v6/v7 は PDS 同期状態と performed sets を追加、v8 で PDS 連携の撤去に伴い
                    // pdsSyncedAt を削除。まだ内部テスト前の Companion 履歴なので同じ方針を継続する。
